...
// Existing icons...
// Fix: Added React.FC type to allow standard React props like 'key' when used in maps
...
export const Layout: React.FC<{ className?: string }> = ({ className }) => (
...
export const FileVideo: React.FC<{ className?: string }> = ({ className }) => (
...
export const Rotate3D: React.FC<{ className?: string }> = ({ className }) => (
...
export const Mesh: React.FC<{ className?: string }> = ({ className }) => (
...
export const Keyframe: React.FC<{ className?: string }> = ({ className }) => (
...
export const PenTool: React.FC<{ className?: string }> = ({ className }) => (
...
export const FilmStrip: React.FC<{ className?: string }> = ({ className }) => (
...
export const Monitor: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
);
