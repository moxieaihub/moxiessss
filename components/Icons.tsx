...
// Using simple SVG icons to avoid external dependency complexity in this single-shot format
export const Wand2 = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M18 2a2 2 0 0 1 2 2v4a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a2 2 0 0 1 2-2h13zm-3 12a2 2 0 0 1 2 2v4a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-4a2 2 0 0 1 2-2h11z"/><line x1="15" y1="2" x2="15" y2="22"/><line x1="9" y1="2" x2="9" y2="22"/></svg>
);
...
export const Square = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}><rect x="4" y="4" width="16" height="16" rx="2" ry="2"/></svg>
);
...
export const Bone = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M17 10c.7-.7 1.69 0 2.5 0a2.5 2.5 0 1 0 0-5 .5.5 0 0 1-.5-.5 2.5 2.5 0 1 0-5 0c0 .81.7 1.8 0 2.5l-7 7c-.7.7-1.69 0-2.5 0a2.5 2.5 0 0 0 0 5c.28 0 .5.22.5.5a2.5 2.5 0 1 0 5 0c0-.81-.7-1.8 0-2.5Z"/></svg>
);
...
export const FileVideo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="m10 11 5 3-5 3v-6"/></svg>
);

export const Cursor = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m4 4 11.733 16.032.774-7.277 6.75-6.75-8.222.774Z"/></svg>
);

export const Rotate3D = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2a10 10 0 1 0 10 10 3 3 0 0 0-3-3"/><path d="M2.05 10a10 10 0 0 1 10-8 3 3 0 0 0 3 3"/><path d="M12 22a10 10 0 0 1-10-10 3 3 0 0 0 3 3"/></svg>
);

export const Scale = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m21 3-6 6"/><path d="M21 3v6"/><path d="M21 3h-6"/><path d="M3 21h6"/><path d="M3 21v-6"/><path d="m3 21 6-6"/><path d="m15 9-6 6"/><path d="M9 9h6v6"/></svg>
);

export const Cube = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m21 16-9 4-9-4"/><path d="m21 8-9 4-9-4"/><path d="M12 12v9"/><path d="M21 8v8a2 2 0 0 1-2 2h-1.1"/><path d="M6.1 20H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h12.28"/><path d="M12 2 2.8 7.3"/><path d="M12 2l9.2 5.3"/></svg>
);

export const Mesh = ({ className }: { className?: string }) => (
...
export const Keyframe = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 2 8.5 8.5-8.5 8.5L3.5 10.5Z"/></svg>
);
...
export const FilmStrip = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="20" height="18" x="2" y="3" rx="2"/><path d="M2 8h20"/><path d="M2 16h20"/><path d="M7 3v18"/><path d="M17 3v18"/></svg>
);
...
export const Key = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4"/><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3h1l2-2V7.5L19 5l-3.5 2.5Z"/></svg>
);
